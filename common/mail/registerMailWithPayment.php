                ...
                <table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
                        <tr>
                                <td>
                                        ...
                                        <p> Hello <?= ($student_details->first_name) ? $student_details->first_name . ',' : " " ?> </p>
                   ...
                   <!-- <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/mastermbbs/site/activation?auth=<?= ($student_details->auth_key) ? $student_details->auth_key : '' ?>&username=<?= ($student_details->user_id) ? $student_details1->user_id : '' ?>">http://<?= $_SERVER['HTTP_HOST'] ?>/mastermbbs/site/activation?auth=<?= ($student_details->auth_key) ? $student_details->auth_key : '' ?>&username=<?= ($student_details->user_id) ? $student_details->user_id : '' ?></a>-->
