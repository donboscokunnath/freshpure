        ...
        <table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
            <tr>
                <td>
                    ...
                    <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/mastermbbs/site/activation?auth=<?= ($model->auth_key) ? $model->auth_key : '' ?>&username=<?= ($model->user_id) ? $model->user_id : '' ?>">http://localhost/mastermbbs/site/activation?auth=<?= ($model->auth_key) ? $model->auth_key : '' ?>&username=<?= ($model->user_id) ? $model->user_id : '' ?></a>
