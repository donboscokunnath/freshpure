            ...
            <tr>
                <td>
                    ...
                    <p> Welcome and we are truly grateful to you for your registration
                        and hope our application will give you whole new experience of learning .”</p>

                    <p>Your credential below:<br/>
                        username : <?= ($model->user_id) ? $model->user_id : "" ?><br/>
                        Password : <?= ($model->password_before) ? $model->password_before : "" ?>
                    </p>

                    <p>Please click the below link to activate your account or copy paste to the browser</p>

                    <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/mastermbbs/site/activation?auth=<?= ($model->auth_key) ? $model->auth_key : '' ?>&username=<?= ($model->user_id) ? $model->user_id : '' ?>">http://localhost/mastermbbs/site/activation?auth=<?= ($model->auth_key) ? $model->auth_key : '' ?>&username=<?= ($model->user_id) ? $model->user_id : '' ?></a>
